...
type
  ...
  private
    ...
    procedure CalculateStandartBlockSize;
...
const
  ...
  SAD_DEVELOPER_MESSAGE = 'Can''t find help args file. Nah, I don''t want print all bunch of args THERE. C''mon it''s just three files, and you miss one of them!';
...
begin
  ...
  begin
    ...
    begin
      MessageBox(0, SAD_DEVELOPER_MESSAGE, 'Sad HEPE developer', MB_OK or MB_ICONEXCLAMATION or MB_TASKMODAL);
      Application.Terminate;
    end;
  end;
...
procedure TForm1.CalculateStandartBlockSize;
begin
...
begin
  self.CalculateStandartBlockSize;
end;
